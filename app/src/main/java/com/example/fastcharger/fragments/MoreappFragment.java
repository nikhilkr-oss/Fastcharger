...
public class MoreappFragment  extends Fragment {
    ...
    public static MoreappFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_moreapps, container, false);

  Integer key = (Integer) SharedPrefUtils.getFromPrefs(getActivity(), "test",new Integer(0));

        Toast.makeText(getActivity(), key.toString(), Toast.LENGTH_SHORT).show();
        return view;
    }
}